...
from app.tasks.sqlalchemy_scheduler_models import DatabaseSchedulerEntry, CrontabSchedule, IntervalSchedule
...
class DatabaseScheduler(Scheduler):
    ...
    def should_sync(self):
        ...
        self.logger.debug('DatabaseScheduler: should_sync: {}'.format(bool_))
        return bool_
